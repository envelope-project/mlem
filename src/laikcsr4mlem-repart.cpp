                    ...
                    const Csr4Matrix& matrix, Laik_Data* norm)
{
    ...
    float* res;
    laik_get_map_1d(norm, 0, (void**) &res, 0);
...
{
    float* n;
    laik_get_map_1d(norm, 0, (void**) &n, 0);
                ...
                )
{
    ...
    float* res;
    laik_get_map_1d(result, 0, (void**) &res, 0);
        ...
        )
{
    ...
    laik_get_map_1d(fwproj, 0, (void**) &fwp, &size);
                ...
                std::chrono::duration<float>& total_time)
{
    ...
    laik_get_map_1d(update, 0, (void**) &res, 0);
        ...
        )
{
    ...
    std::chrono::time_point<std::chrono::system_clock> start2, fin;
    float* up;
    laik_get_map_1d(update, 0, (void**) &up, 0);
    float* nm;
    laik_get_map_1d(norm, 0, (void**) &nm, 0);
